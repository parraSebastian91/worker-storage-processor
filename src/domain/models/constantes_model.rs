...
pub const CATEGORY_PROCESS_DOCUMENT_DTO: &str = "DTE-factura";
pub const CATEGORY_PROCESS_DOCUMENT_DTO_RESPALDO: &str = "DTE-factura-respaldo";
pub const CATEGORY_PROCESS_SOCIAL_POST: &str = "social-post";
pub const CATEGORY_PROCESS_OTHER: &str = "OTHER";
pub const CATEGORY_PROCESS_ORG_AVATAR: &str = "org-avatar";
pub const CATEGORY_PROCESS_ORG_BANNER: &str = "org-banner";
pub const CATEGORY_PROCESS_DOCUMENT_OC: &str = "orden-compra";
pub const CATEGORY_PROCESS_DOCUMENT_GD: &str = "guia-despacho";
pub const CATEGORY_PROCESS_DOCUMENT_AE: &str = "acta-entrega";
pub const CATEGORY_PROCESS_DOCUMENT_EP: &str = "estado-pago";
pub const CATEGORY_PROCESS_DOCUMENT_HES: &str = "hoja-entrada-servicio";
...
pub const STATE_PROCESS_DEPRECATED: &str = "DEPRECATED";
